    ...
    <div>
      ...
      <div className="max-w-3xl mx-auto px-4 pt-16 pb-12 text-center">
        ...
        <h1 className="text-4xl font-medium text-gray-900 mb-4 leading-tight">
          The right gear for <span style={{ color: BRAND_GREEN }}>your</span> game.<br />
        ...
        <div className="flex items-center justify-center gap-3 mb-10">
          ...
          <Link
            to="/about"
            className="px-6 py-2.5 rounded-lg text-sm text-gray-600 border border-gray-200 hover:border-gray-400 transition-all"
          >
            How it works
          </Link>
        </div>
      ...
      <div className="border-t border-gray-100">
        <div className="max-w-3xl mx-auto px-4 py-12">
          <p className="text-xs font-semibold uppercase tracking-wider mb-2" style={{ color: BRAND_GREEN }}>Sports</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white border-2 rounded-xl p-5" style={{ borderColor: BRAND_GREEN }}>
              <div className="text-2xl mb-3">⛳</div>
              <h3 className="text-sm font-medium text-gray-900 mb-1">Golf</h3>
              <p className="text-xs text-gray-500 mb-3 leading-relaxed">Find clubs and accessories matched to your handicap, swing tendencies, and budget.</p>
              <span className="inline-flex items-center gap-1.5 text-xs px-2.5 py-1 rounded-full" style={{ background: BRAND_GREEN_LIGHT, color: BRAND_GREEN }}>
                <span className="w-1.5 h-1.5 rounded-full" style={{ background: BRAND_GREEN }} />
                Live now
              </span>
              <div className="flex flex-wrap gap-1.5 mt-3">
                {['Irons ✓', 'Drivers', 'Wedges', 'Putters', 'Full sets', 'Shoes'].map(s => (
                  <span key={s} className={`text-xs px-2 py-0.5 rounded-full ${s.includes('✓') ? '' : 'bg-gray-100 text-gray-400'}`}
                    style={s.includes('✓') ? { background: BRAND_GREEN_LIGHT, color: BRAND_GREEN } : {}}>
                    {s}
                  </span>
                ))}
              </div>
            </div>
            <div className="bg-gray-50 border border-dashed border-gray-200 rounded-xl p-5 flex flex-col items-center justify-center text-center">
      ...
      <div className="border-t border-gray-100 bg-white">
        <div className="max-w-3xl mx-auto px-4 py-12">
          <p className="text-xs font-semibold uppercase tracking-wider mb-2" style={{ color: BRAND_GREEN }}>How it works</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              ...
              <div key={s.n} className="bg-gray-50 rounded-xl p-4">
                <div className="w-7 h-7 rounded-full flex items-center justify-center text-xs font-medium text-white mb-3" style={{ background: BRAND_GREEN }}>{s.n}</div>
      ...
      <div className="border-t border-gray-100">
        <div className="max-w-3xl mx-auto px-4 py-12">
          <p className="text-xs font-semibold uppercase tracking-wider mb-2" style={{ color: BRAND_GREEN }}>Why us</p>
      ...
      {/* CTA band */}
      <div className="py-14 px-4 text-center" style={{ background: BRAND_GREEN_DARK }}>
        <h2 className="text-xl font-medium text-white mb-2">Ready to find your gear?</h2>
        <p className="text-sm mb-7 max-w-sm mx-auto leading-relaxed" style={{ color: 'rgba(255,255,255,0.6)' }}>
          Start with golf irons — answer a few quick questions and get your personalised matches in under a minute.
        </p>
        <Link
          to="/golf/irons"
          className="inline-block px-6 py-2.5 rounded-lg text-sm font-medium hover:opacity-90 transition-all"
          style={{ background: '#fff', color: BRAND_GREEN_DARK }}
        >
          Find my gear ↗
        </Link>
      </div>
      ...
      <div className="border-t border-gray-100 bg-gray-50">
        <div className="max-w-3xl mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
            <div>
              <p className="text-xs font-semibold uppercase tracking-wider mb-2" style={{ color: BRAND_GREEN }}>Coming soon</p>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSuggest} className="flex flex-col gap-3">
                <input
                  ...
                  required
                  className="px-3 py-2.5 rounded-lg border border-gray-200 bg-white text-sm text-gray-900 focus:outline-none focus:border-green-400"
                />
                <select
                  value={sport}
